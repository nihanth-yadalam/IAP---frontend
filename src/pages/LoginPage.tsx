      ...
      <Card className="relative w-full max-w-md rounded-2xl bg-card text-card-foreground border border-border shadow-xl animate-scale-in">
        ...
        <CardContent className="pt-2">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              variant="default"
              className="w-full h-11 rounded-xl font-semibold bg-primary text-primary-foreground hover:bg-primary/90 transition-transform active:scale-[0.98]"
              type="submit"
              disabled={isLoading}
            >
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-11 rounded-xl border-border text-foreground hover:bg-accent active:scale-[0.98] transition-transform"
