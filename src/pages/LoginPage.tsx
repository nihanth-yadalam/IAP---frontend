...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center px-4 py-8 overflow-hidden bg-background">
      ...
      <div className="absolute top-1/2 left-1/2 w-64 h-64 rounded-full bg-vibrant-pink/10 dark:bg-vibrant-pink/20 blur-3xl animate-float" style={{ animationDelay: "2s" }} />
